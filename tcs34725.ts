...
namespace smartfeldSensoren {
    ...
    export class TCS34725 {
        ...
        initSensor() {
            ...
            this.TCS34725_I2C_ADDR = TCS34725_I2C_ADDRESS;
        ...
        turnSensorOn(atime: TCS34725_ATIME) {
            ...
            RegisterHelper.writeRegister(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_ENABLE, TCS34725_REGISTER_PON_ENABLE);
            basic.pause(300);
            ...
            RegisterHelper.writeRegister(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_ENABLE, TCS34725_REGISTER_PON_ENABLE | TCS34725_REGISTER_AEN_ENABLE);

            this.pauseSensorForIntegrationTime(atime);
        }

        pauseSensorForIntegrationTime(atime: TCS34725_ATIME) {
            switch (atime) {
        ...
        turnSensorOff() {
            //REGISTER FORMAT:   CMD | TRANSACTION | ADDRESS
            //REGISTER READ:     TCS34725_REGISTER_COMMAND (0x80) | TCS34725_REGISTER_ID (0x12)        
            let sensorReg = RegisterHelper.readRegister8(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_ENABLE);

            //REGISTER FORMAT:   CMD | TRANSACTION | ADDRESS
            //REGISTER VALUE:    TCS34725_REGISTER_COMMAND (0x80) | TCS34725_REGISTER_ENABLE (0x00)
            //REGISTER WRITE:    sensorReg & ~(TCS34725_REGISTER_PON_ENABLE (0x01) | TCS34725_REGISTER_AEN_ENABLE (0x02))            
            RegisterHelper.writeRegister(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_ENABLE, sensorReg & ~(TCS34725_REGISTER_PON_ENABLE | TCS34725_REGISTER_AEN_ENABLE));
        }

        tsetATIMEintegration(atime: TCS34725_ATIME) {
            ...
            RegisterHelper.writeRegister(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_ATIME, atime)
        ...
        setGAINsensor(gain: TCS34725_AGAIN) {
            ...
            //REGISTER WRITE:    gain         
            RegisterHelper.writeRegister(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_CONTROL, gain)
        ...
        start(atime: TCS34725_ATIME, gain: TCS34725_AGAIN) {
            ...
            this.tsetATIMEintegration(atime);
        ...
        getSensorRGB(): RGBC {
            ...
            let redColorValue = RegisterHelper.readRegisterUInt16(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_RDATAL);

            //REGISTER FORMAT:   CMD | TRANSACTION | ADDRESS
            //REGISTER READ:     TCS34725_REGISTER_COMMAND (0x80) | TCS34725_REGISTER_GDATAL (0x18)          
            let greenColorValue = RegisterHelper.readRegisterUInt16(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_GDATAL);

            //REGISTER FORMAT:   CMD | TRANSACTION | ADDRESS
            //REGISTER READ:     TCS34725_REGISTER_COMMAND (0x80) | TCS34725_REGISTER_BDATAL (0x1A)          
            let blueColorValue = RegisterHelper.readRegisterUInt16(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_BDATAL);

            //REGISTER FORMAT:   CMD | TRANSACTION | ADDRESS
            //REGISTER READ:     TCS34725_REGISTER_COMMAND (0x80) | TCS34725_REGISTER_CDATAL (0x14)          
            let clearColorValue = RegisterHelper.readRegisterUInt16(this.TCS34725_I2C_ADDR, TCS34725_REGISTER_COMMAND | TCS34725_REGISTER_CDATAL);
        ...
        getSensorData(colorId: RGB): number {
            let data = this.getSensorRGB();
            let color = 0;
